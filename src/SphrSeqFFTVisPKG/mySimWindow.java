...
//		float[] res2 = fftMP3Log.getSpectrumImaginary();
		...
		for(int i=0;i<specSize;++i) {
			bandRes[i] = fftMP3Log[songIDX].getBand(i);			
		}
		float[] res1 = fftMP3Log[songIDX].getSpectrumReal();
		float[] res2 = fftMP3Log[songIDX].getSpectrumImaginary();
